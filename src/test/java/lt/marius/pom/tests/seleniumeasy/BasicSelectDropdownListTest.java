...
public class BasicSelectDropdownListTest extends TestBase {
    ...
    @Test
    public void testSelectedCityGroupWithActions() {
        List<String> selectValues = Arrays.asList("California", "New Jersey", "Ohio", "Pennsylvania");
        boolean isSelected = true;
        boolean expectedResult = true;
        boolean actualResult;

        BasicSelectDropdownListPage.selectCitiesFromListWithActions(selectValues);
        BasicSelectDropdownListPage.clickButtonGetAllSelected();
        actualResult = BasicSelectDropdownListPage.checkNamesOfSelectedCities(selectValues, isSelected);
